function  display_bump_dynamics_turning_ephys(df_f_in_roi_per_trial, ephys_time, ephys_data, bdata_vel_time, bdata_vel, VPS, analysis_path, sid)
...
NUM_PB_GLOMERULI_HALF = 9;
PB_GLOMERULI_MID = 5;

PB_half = [ 1:NUM_PB_GLOMERULI_HALF ];

stability_markers = [];
for tr = 1:size(roi_ts_per_trial,2)
