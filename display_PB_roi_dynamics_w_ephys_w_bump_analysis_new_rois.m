function [roi_ts_per_trial] = display_left_PB_glomeruli_dynamics_w_ephys_w_bump_analysis( EPG_data, PEN_data,  ephys_time, ephys_data, bdata_vel_time, bdata_vel, VPS, analysis_path, sid, pre_stim, stim_dur )
...
rois = get_left_half_PN_glomeruli(squeeze(mean(squeeze(mean(EPG_data(:,:,:,:),4)),1)), analysis_path);
