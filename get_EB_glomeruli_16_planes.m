function [glom] = get_EB_glomeruli_16_planes( EPG_data, analysis_path )
...
%     glom{5,1} = [1:3]; glom{6,1} = [1:3]; glom{7,1} = [4:5];  glom{8,1} = [4:5];
    ...
    % 181022_Lex_6f_60D05_Gal4_P2X2_PEN1_recomb_15 - EB
     glom{1,1} = [1:4]; glom{2,1} = [1:4]; glom{3,1} = [1:4];  glom{4,1} = [5:8];
     glom{5,1} = [9:12]; glom{6,1} = [9:12]; glom{7,1} = [9:12];  glom{8,1} = [5:8];
