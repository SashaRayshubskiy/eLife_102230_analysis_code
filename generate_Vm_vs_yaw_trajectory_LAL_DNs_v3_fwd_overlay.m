...
saveas(f, [analysis_path '/fwd_vel_overlay_trajectory_' file_str '_vs_yaw.fig' ]);
saveas(f, [analysis_path '/fwd_vel_overlay_trajectory_' file_str '_vs_yaw.png' ]);

f = figure;
histogram(fwd_vels, 40);
saveas(f, [analysis_path '/fwd_vel_histogram_' file_str '.fig' ]);
saveas(f, [analysis_path '/fwd_vel_histogram_' file_str '.png' ]);
