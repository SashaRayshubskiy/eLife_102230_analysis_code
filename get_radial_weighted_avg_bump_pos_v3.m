function  [ smoothed_bump, bump_motion_ids ] = get_radial_weighted_avg_bump_pos_v3( bump_gloms )
...
for ts = 1:n_frames
    ...
    if( max(cur_EB_bump_final) < NO_BUMP_THRESHOLD )
