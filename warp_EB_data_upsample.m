function warp_EB_data_upsample( stim_events, VPS, analysis_path )

settings = sensor_settings;

PEAK_EB_BUMP_FRAME = 10470;
REFERENCE_EB_TC = 14;
...
for i = 1:num_stims
    ...
    cur_yaw_snip = yaw_tw_data{i}( PEAK_EB_BUMP_FRAME:end );
    yaw_warped{i}   = cur_yaw_snip( iy );

    cur_ephys_snip = ephys_tw_data{i}( PEAK_EB_BUMP_FRAME:end );
    ephys_warped{i}   = cur_ephys_snip( iy );
