function [ bdata_raw, bdata_time, trial_metadata ] = load_behavioral_data_v2( sids, datapath, trial_type_cnt)
...
% session
% 
% This version also outputs the chronological timestamp
...
for sid = sids
    ...
    for f = 1:length(files)
        ...
        x = [filename_split(3) '_' filename_split(4)];
        tt = datetime(str2num(x(1:4)), str2num(x(5:6)), str2num(x(7:8)), str2num(x(10:11)), str2num(x(12:13)), str2num(x(14:15)))
