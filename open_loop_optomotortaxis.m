...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Load behavioral data from JL
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bdata_path = [datapath  slash 'ball' slash ];

tic; [ b_rawdata, b_time, btrial_meta ] = load_behavioral_data_JL(sid, bdata_path, trial_type_cnt ); toc
% Get behavioral data that is usable for analysis

[bdata_vel_time, ~, ~, bdata_vel] = reformat_raw_behavioral_data_JL( b_time, b_rawdata );
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%
display_open_loop_vis_avg_tc(cdata_raw, VPS, analysis_path);
...
display_open_loop_viz_avg_velocity(sid, b_rawdata, bdata_vel, bdata_vel_time, analysis_path);
