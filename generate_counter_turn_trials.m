function [ct_list] = generate_counter_turn_trials( bdata_vel_time, bdata_vel, analysis_path )
...
[ condition_trials, condition_trials_str, condition_str ] = generate_counter_turn_vs_no_counter_turn_trial_list( 0, bdata_vel_time, bdata_vel, turn_metadata, analysis_path );
