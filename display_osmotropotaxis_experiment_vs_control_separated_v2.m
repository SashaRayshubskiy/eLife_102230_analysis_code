function display_osmotropotaxis_experiment_vs_control_separated_v2( t_volts, volts_all, t_vel_all, yaw_vel_all, forward_vel_all, analysis_dir )
...
saveas(f, [analysis_dir '/osmotropotaxis_vs_control_behavior_and_ephys_avg_fbc.fig']);
saveas(f, [analysis_dir '/osmotropotaxis_vs_control_behavior_and_ephys_avg_fbc.png']);
