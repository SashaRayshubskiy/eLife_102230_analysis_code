function display_thermotaxis_experiment( t_volts, volts_all, t_vel_all, yaw_vel_all, forward_vel_all, analysis_dir ) 
...
saveas(f, [analysis_dir '/thermotaxis_behavior_and_ephys_avg_fbc.fig']);
saveas(f, [analysis_dir '/thermotaxis_behavior_and_ephys_avg_fbc.png']);
