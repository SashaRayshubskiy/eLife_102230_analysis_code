function [ image_cnts ] = generate_Vm_vs_yaw_trajectory_LAL_DNs_v2(sids, t_volts, volts_all, t_vel_all, yaw_vel_all, forward_vel_all, analysis_path, CALC_PSTH, analysis_path_type)
...
saveas(f, [analysis_path '/trajectory_' file_str '_vs_yaw_shift_' num2str(CURRENT_SHIFT*DT*0.01) '_sec.fig' ]);
saveas(f, [analysis_path '/trajectory_' file_str '_vs_yaw_shift_' num2str(CURRENT_SHIFT*DT*0.01) '_sec.png' ]);
