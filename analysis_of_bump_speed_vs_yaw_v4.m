function analysis_of_bump_speed_vs_yaw_v4( exp_dirs, VPS, analysis_path )
...
for d = 1:length(exp_dirs)
    ...
    % for s = 10
        ...
        if 1
            f = figure( 'outerposition', [668 658 583 465] );
            ...
            subplot(5,1,5);
            hold on;
            plot( t_ephys_w(ephys_interval), cur_ephys_in_interval );
            axis tight;
